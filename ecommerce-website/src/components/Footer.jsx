    ...
    <footer>
      <div className="upper">
        ...
        <div className="contact">
          <h3>Contact us</h3>
          <ul>
            <li><i className="bi bi-envelope-fill" /><a href="mailto:support@example.com">Email: support@example.com</a></li>
            <li><i className="bi bi-telephone-fill" /><a href="#">Phone: +123 456 7890</a></li>
            <li><i className="bi bi-geo-alt-fill" /><a href="#">Address: 123 Main St, City, State, ZIP</a></li>
          </ul>
        </div>
        <div className="links">
          <h3>Quick Links</h3>
      ...
      <div className="lower">
        ...
        <div className="social-media">
          ...
          <a href="https://instagram.com"><i className="bi bi-instagram" /></a>
          <a href="https://whatsapp.com"><i className="bi bi-whatsapp" /></a>
        </div>
      </div>
    </footer>
  );
